...
title: "ML basics - Probability Distributions 1"
categories: DevCourse2 ProbabilityDistributions MathJax DevCourse2_ML_Basics
tags: DevCourse2 ProbabilityDistributions MathJax DevCourse2_ML_Basics
# 목차
toc: true  
toc_sticky: true 
toc_label : "Contents"
...
> 로그로 바꿔줘서 곱 $$\prod$$의 형태에서 합 $$\sum$$의 형태로 변환시킨다는데 로그했을때 합으로 왜 되는지  
